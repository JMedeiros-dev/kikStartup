...
<h3 class="mt-4">Results for: <c:out value="${job}"/> </h3>
...
<table class="table table-responsive-sm table-striped">
    ...
    <tbody>
        ...
        <tr>
            <td class="text-center table-link"><a href="/jobs/${r.id}"><c:out value="${r.title}"/></a></td>
            <td class="text-center"><c:out value="${r.company}"/></td>
            <td class="text-center"><c:out value="${r.location}"/></td>
            <td class="text-center"><c:out value="${r.remote}"/></td>
        </tr>
        </c:forEach>
    </tbody>
</table>
