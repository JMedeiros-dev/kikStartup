...
<p class="create-job-text text-center"> Post a Job </p>
<form:form action="/new-job" method="post" class=" col-10 login-form" modelAttribute="job" >
...
<div class="form-group d-flex justify-content-center">
     ...
     <div class="form-group d-flex justify-content-center">
    <input type="submit" class="btn btn-primary text-white  col-10" value="Post"/>
    </div>
</form:form> 
