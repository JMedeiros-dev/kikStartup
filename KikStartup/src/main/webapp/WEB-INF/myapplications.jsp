...
<h3 class="mt-4">My Applications</h3>
...
<table class="table table-responsive-sm table-striped">
    ...
    <tbody>
        ...
        <tr>
            <td class="text-center table-link"><a href="/jobs/${app.id}"><c:out value="${app.title}"/></a></td>
            <td class="text-center"><c:out value="${app.company}"/></td>
            <td class="text-center"><c:out value="${app.location}"/></td>
            <td class="text-center"><c:out value="${app.remote}"/></td>
        </tr>
        </c:forEach>
    </tbody>
</table>
<a class="btn btn-primary col-12 text-white" href="/jobs">Apply To More Jobs!</a>
