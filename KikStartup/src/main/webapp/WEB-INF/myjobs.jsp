...
<table class="table table-striped">
    ...
    <tbody>
        ...
        <tr>
            <td class="text-center table-link"><a href="/jobs/${job.id}"><c:out value="${job.title}"/></a></td>
            <td class="text-center"><c:out value="${job.company}"/></td>
            <td class="text-center"><c:out value="${job.location}"/></td>
            <td class="text-center"><c:out value="${job.remote}"/></td>
            <td class="text-center"><a href="/jobs/${job.id}/edit" class="">Edit</a> | <a href="/delete/${job.id}" class="">Delete</a></td>
        </tr>
        </c:forEach>
    </tbody>
</table>
<a class="btn sign-up col-12 text-white" href="/new-job">Post a new job</a>
